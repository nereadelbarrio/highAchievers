	...
	highAchiversStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Título highAchivers', element: 'h2', attributes: { 'class': 'bck-title bck-title-3'} },
				{ name: 'Título 4 Naranja', element: 'h2', attributes: { 'class': 'bck-title bck-title-4'} },
				{ name: 'Título Project', element: 'h2', attributes: { 'class': 'bck-title bck-title-5'} },
				{ name: 'Título highAchiversNaranja', element: 'h2', attributes: { 'class': 'bck-title bck-title-6'} },
				{ name: 'Título Reading', element: 'h2', attributes: { 'class': 'bck-title bck-title-7'} },
				{ name: 'Título Communication', element: 'h2', attributes: { 'class': 'bck-title bck-title-8'} },
				{ name: 'Título 1-Izquierda', element: 'h2', attributes: { 'class': 'bck-title bck-title-9'} },
				...
				{ name: 'Título azul', element: 'h2', attributes: { 'class': 'bck-title bck-title-12'} },
				{ name: 'Título Wordlist', element: 'h2', attributes: { 'class': 'bck-title bck-title-13'} },
				{ name: 'Título GrammarReference', element: 'h2', attributes: { 'class': 'bck-title bck-title-14'} },
				...
				{ name: 'Caja 1', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box bck-title bck-box-1' } },
				{ name: 'Caja 2', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box bck-title bck-box-2' } },
				{ name: 'Caja 3', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box bck-title bck-box-3' } },
				{ name: 'Caja 4', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box bck-title bck-box-4' } },
				{ name: 'Caja 5', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box bck-title bck-box-5' } },
